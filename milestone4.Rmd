...
kable(my_new_table_data, 
      booktabs=T, 
      col.names=c("Time Period", "Region", "Bacterial", "Fungal", "Parasitic"),  
      align='lccc', 
      caption="Infectious disease rates over time by disease etiology (from 2001 - 2018 by 3 year increments)",
