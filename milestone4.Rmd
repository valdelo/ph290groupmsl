...
ggplot(plotdata, aes(x=Year, y=Mean_Rate))+geom_line(stat="identity")+facet_wrap(vars(Disease_Type))+labs(x="Year", y="Mean Rate", title = "Mean rates of Infectious diseases (including STDs) in Bay Area Counties from 2001-2018") + theme_minimal()
```
...
ggplot(plotdata2, aes(x=Year, y=Mean_Rate))+geom_line(stat="identity")+facet_wrap(vars(Disease_Type), ncol = 2)+labs(x="Year", y="Mean Rate", title = "Mean rates of Infectious Diseases in Bay Area Counties from 2001-2018") + theme_minimal()
```

```{r}
plotdata3<-plotdata%>% filter(Disease_Type == "STD (Bacterial)")

ggplot(plotdata3, aes(x=Year, y=Mean_Rate))+geom_line(stat="identity")+facet_wrap(vars(Disease_Type))+labs(x="Year", y="Mean Rate", title = "Mean rates of STDs (Bacterial) in Bay Area Counties from 2001-2018") + theme_minimal()
