...
### Discussion: 
As shown from our graphs and tables, rates of STDs, bacteria and fungal infections are increasing from the time period of 2001 to 2018. More specifcally, rates of STDs are much higher than other disease types. This may mean that in the future, from a public health perspective, efforts to reduce transmission and prevalance of STDs is very important. Additionally, rates of each STD (chlamydia, gonorrhea, and early syphilis) have been increasing from 2014 to 2018 and rates of Chlamydia are much higher than rates of the other two STDs included in the dataset. This may also mean that focusing on reducing tranmission and rates of Chlamydia is important to reduce overall rates of STDs in the Bay Area. In the future, it may also be interesing to compare STD trends in california to STD trends in the Bay Area. 
