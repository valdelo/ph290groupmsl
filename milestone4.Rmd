...
Interpretation of graph: This graph looks at the overall rates per year of different types of infectious disease in the Bay area counties from 2001 to 2018, without an adjusted Y axis. From the graphs it is noticeable that STD rates are increasing at a much greater level than other types of infectious diseases. 
\newpage
```{r}
