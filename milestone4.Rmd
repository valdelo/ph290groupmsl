...
### Discussion: 
As shown from our graphs and tables, rates of STIs, bacteria and fungal infections have been increasing during the time period of 2001 to 2018. Since 2017, we have a new infectious diseases reported that include zika virus and chikungunya virus. The addition of these viruses have increased the reportable viral disease from 0.04 per 100,000 in 2001-2003 to 0.99 per 100,000 2016-2018.
Rates of STIs have continued to rise a faster rate than any other disease type in the Bay Area. This may mean that in the future, from a public health perspective, efforts to reduce transmission and prevalance of STIs is very important. Additionally, STIs (chlamydia, gonorrhea, and early syphilis) have been increasing at an even faster rate from 2014 to 2018 and rates of Chlamydia are much higher than rates of the other two STIs included in the dataset. This may also mean that focusing on reducing tranmission and rates of Chlamydia is important to reduce overall rates of STIs in the Bay Area. Of particular interest is the rapid increase of syphilis cases in the period 2014 (26.20 per 100,000) to almost double in 2018 (41.31 per 100,000). These numbers show that there is a growing STD epidemic in the Bay Area. According to the CDC, factors that contribute to this include "drug use, poverty, unstable housing, reduced access to STD prevention and care, decreased condom use, and cuts to both state and local STD programs" (CDC). This data shows the important of surveillance to identify outbreaks and the effects of public health interventions and policies. Ideally we should see all these infectious diseases decrease overtime. We will continue to monitor and hopefully see positive impact of multi-level interventions and improvements of social determinants of health. 

CDC Reference Source: https://www.cdc.gov/nchhstp/newsroom/2019/2018-STD-surveillance-report-press-release.html