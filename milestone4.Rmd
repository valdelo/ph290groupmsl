...
ggplot(plotdata, aes(x=Year, y=Mean_Rate))+geom_line(stat="identity")+facet_wrap(vars(Disease_Type))+labs(x="Year", y="Mean Rate", title = "Mean rates of Infectious diseases (including STDs) in Bay Area Counties from 2001-2018") + theme_classic()+ scale_color_manual(values=c("#ffd333","#ff6600","#be0f24","#f91cc7","#910ff5","#003884")) 
```
...
ggplot(plotdata3, aes(x=Year, y=Mean_Rate))+geom_line(stat="identity", color= "#ffd333")+facet_wrap(vars(Disease_Type))+labs(x="Year", y="Mean Rate", title = "Mean rates of STDs (Bacterial) in Bay Area Counties from 2001-2018") 
